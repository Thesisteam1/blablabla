...
<li><a href="delete deptscript.php"class="active">Delete Department</a></li>
...
<form method="POST" action="delete deptscript.php">

   
<B><font face="italic" color="black">Select Department</I></B></a><br/>
<select name="deptcode" class=imputstyle>
<option selected = "selected" style="width: 200px; height: 25px" ></option>
...
?>
  ...
  <input type="submit"  class="one" value="DELETE">
